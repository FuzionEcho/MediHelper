  ...
  const medicalIntents = [
    {
      ...
      response:
        "You can manage your medical bills in the Bills & Payments section. Would you like me to help you navigate there?",
    },
    {
      patterns: ["appointment", "schedule", "doctor", "clinic", "visit"],
      response:
        "You can schedule appointments in the Appointments section. Would you like me to help you navigate there?",
    },
    {
      patterns: ["insurance", "coverage", "plan", "policy"],
      response:
        "You can find insurance information in the Insurance section. Would you like me to help you navigate there?",
    },
    {
      patterns: ["transport", "ride", "car", "pickup"],
      response:
        "You can arrange transportation in the Transportation section. Would you like me to help you navigate there?",
    },
    {
      patterns: ["dashboard", "overview", "summary", "home"],
      response:
        "The Dashboard provides an overview of your healthcare information. Would you like me to help you navigate there?",
    },
    {
      patterns: ["setting", "account", "profile", "preference"],
      response: "You can adjust your settings in the Settings section. Would you like me to help you navigate there?",
    },
    {
